    ...
    return (
        <div className="homeCont container-fluid">
            <div className="header container">
                ...
                <p>
                    The senior you always wanted. Stay updated with latest and relevant announcements with one-click away. Want best notes for exam preparation<br /> <span> <img src={underline} alt="" />-Done!</span>
                </p>
            </div>
